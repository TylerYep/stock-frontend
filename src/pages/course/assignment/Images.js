	...
	<div className="container container-course">
            ...
            <div className="col-sm-12">
                <div id="pageHeader">
                    ...
                    <p className="subtleHeading"><span className="sidebaricon glyphicon glyphicon-calendar"
                            aria-hidden="true"></span>Goal deadline: Wednesday, May 13th, 11:59PM Anywhere on Earth
                    </p>
        ...
        <div className="row">
            <div className="col-sm-12">
                <p>
                    <center>
                        <img style={{"width":"100%", 'maxWidth':800}}src={ImagesImg}></img>
                    </center>
                    <br /><br />
                </p>
                    ...
                    <div className="col-sm-12">
                        <center>
                            <p style={{"textAlign":"center"}}>
                                <i>Your third assignment consists of several image algorithms.</i>
                ...
                <p>
                    <div className="row">
                        <div className="col-sm-2 text-center"><a target="_blank" href="//codeinplace2020.github.io/faqs/Assignment3.pdf">
                        ...
                        <div className="col-sm-2 text-center"><a href="//codeinplace2020.github.io/faqs/Assignment3.zip">
                        ...
                        <div className="col-sm-2 text-center"><a target="_blank" href="https://us.edstem.org/courses/490/lessons/1236/slides/6431">
                            <FontAwesomeIcon icon={faCode} aria-hidden="true" style={{
                                "fontSize": "5em",
                                "marginLeft":"0px"
                            }}/>
